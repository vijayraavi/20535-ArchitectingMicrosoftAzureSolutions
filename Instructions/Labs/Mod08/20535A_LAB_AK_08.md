...
1. Perform the following actions:
    ...
    a. In the **Resource group** section, enter the value **MOD08LSVM**.
...
1. Back in the **Custom deployment** blade, perform the following actions:
    ...
    a. In the **Resource group** section, enter the value **MOD08LMVM**.
...
1. Wait for the **run command** operation to finish before moving on with this lab.
...
1. In the **** blade that appears, perform the following actions:
